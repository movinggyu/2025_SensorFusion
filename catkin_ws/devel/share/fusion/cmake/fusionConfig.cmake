...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /home/dlehdrb/foscar/2025_SensorFusion/catkin_ws/src/fusion)
  set(fusion_DEVEL_PREFIX /home/dlehdrb/foscar/2025_SensorFusion/catkin_ws/devel)
  set(fusion_INSTALL_PREFIX "")
  set(fusion_PREFIX ${fusion_DEVEL_PREFIX})
else()
  set(fusion_SOURCE_PREFIX "")
  set(fusion_DEVEL_PREFIX "")
  set(fusion_INSTALL_PREFIX /home/dlehdrb/foscar/2025_SensorFusion/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlehdrb/foscar/2025_SensorFusion/catkin_ws/src/fusion/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dlehdrb/foscar/2025_SensorFusion/catkin_ws/devel/lib;/home/dlehdrb/catkin_ws/devel/lib;/opt/ros/noetic/lib)
